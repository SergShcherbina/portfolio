            ...
            <div className={styles.wrapperFooter}>
                <Fade>
                    <h5 className={styles.title}>
                        {footerTextModel.name}
                    </h5>

                    <ul className={styles.listItem}>
                        {contactTextModel.contacts.map(el => (
                            <li className={styles.item} key={el.description}>
                                <a className={styles.link} href={el.link}  target="_blank" rel="noopener noreferrer">
                ...
                <p className={styles.copyright}> {footerTextModel.copyright} </p>
            </div>
        </footer>
    )
};
